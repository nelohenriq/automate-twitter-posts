...
class ViralContentCreators:
    ...
    def trending_topic_researcher_agent(self):
        return Agent(
            ...
            goal=dedent(
                """\
				Identifique e compile uma lista de tópicos de pesquisas e tendênciasatuais
				dentro de um nicho específico. Esta lista deve fornecer insights acionáveis
				e oportunidades de engajamento estratégico, ajudando a orientar criação de conteúdo
				."""
            ),
            backstory=dedent(
                """\
				Como pesquisador de Trending Topics numa agência de
				marketing de topo, a sua principal responsabilidade é monitorizar e
				descodificar o pulso do mercado. Usando ferramentas analíticas avançadas,
				você descobre e lista as tendências mais relevantes que podem influenciar
				decisões estratégicas na criação de conteúdo.
"""
            ),
            tools=[
